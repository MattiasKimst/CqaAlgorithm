 ...
 */
public class Q8 implements Query {
    ...
    public Query createWithPluggedVariables(List<String> freeVariables) {
        return new Q8(freeVariables.getFirst(), freeVariables.getLast());
    }
    ...
    private Boolean booleanQueryCondition(R1 r1Fact, R2_4 r2_4Fact) {
        return queryCondition(r1Fact, r2_4Fact) && r1Fact.z.equals(z) && r2_4Fact.w.equals(w);
    }
